...
public class QuickClickGuard {
     ...
     * 默认的快速点击定义的时间间隔值
     */
    private static final long DEFAULT_LIMIT_TIME = ViewConfiguration.getDoubleTapTimeout();
     ...
     *
     * @param clickObjectId 在一定范围内一个对象的唯一id,通常对于view,
     *                      使用view id作为clickObjectId是个不错的选择,其他情况hashCode是个不错的选择
     */
