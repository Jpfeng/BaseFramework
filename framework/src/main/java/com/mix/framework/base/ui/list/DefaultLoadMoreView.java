...
public class DefaultLoadMoreView extends LoadMoreView {
    ...
    public void showNormal() {
        ...
        mTvHint.setText(StringUtils.getString(R.string.loading_more));
    }

    @Override
    public void showLoading() {
        mPbProgress.setVisibility(View.VISIBLE);
        mTvHint.setText(StringUtils.getString(R.string.loading_more_loading));
    }
    ...
    public void showNoMore() {
        mPbProgress.setVisibility(View.GONE);
        mTvHint.setText(StringUtils.getString(R.string.loading_more_end));
    }
}
